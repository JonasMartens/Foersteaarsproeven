...
namespace ProudChickenEksamen.Controller
{
    class Controller
    {
        ...
        //----------------------MainMenuCasesMetode---------------------------------------------------------------------------------------------------------------------
        public void InsertSmsTypeOgDatoTilDatabase(int a)
        {
            repository1.Insert(a);
        }
        public void OpdaterKontaktSammenlægning(int a, List<Kunde> b)
        {
            //repository1.InsertSmsKontakter(a, b);
        }
        public void Run()
        {
            while (true)
